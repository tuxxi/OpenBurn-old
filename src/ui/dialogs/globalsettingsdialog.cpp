...
void GlobalSettingsDialog::SetupUI()
{
    ...
    unitsLayout->addWidget(m_metricUnitsButton = new QPushButton(tr("All Metric")), 255, 1);
    unitsLayout->addWidget(m_imperialUnitsButton = new QPushButton(tr("All Imperial")), 255, 2);
